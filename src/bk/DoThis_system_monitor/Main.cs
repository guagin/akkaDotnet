    ...
    public partial class Main : Form
    {
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            _toggleActors[CounterType.Cpu] = Program.ChartActors.ActorOf(
                ...
                CounterType.Cpu, false)).WithDispatcher("akka.actor.synchronized-dispatcher"));
            ...
            _toggleActors[CounterType.Memory] = Program.ChartActors.ActorOf(
                ...
                CounterType.Memory, false)).WithDispatcher("akka.actor.synchronized-dispatcher"));

            _toggleActors[CounterType.Disk] = Program.ChartActors.ActorOf(
                Props.Create(() => new ButtonToggleActor(_coordinatorActor, btnDisk,
                CounterType.Disk, false)).WithDispatcher("akka.actor.synchronized-dispatcher"));
        ...
        private void bunMemory_Click(object sender, EventArgs e)
        {
